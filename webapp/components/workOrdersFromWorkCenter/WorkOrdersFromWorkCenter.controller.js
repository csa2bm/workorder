sap.ui.define([
	...
	return Controller.extend("com.twobm.mobileworkorder.components.workOrdersFromWorkCenter.WorkOrdersFromWorkCenter", {
		onInit: function() {
		...
		onFilterAssigned: function(oEvent) {
			...
			if (!this._actionSheetAssigned) {
				this._actionSheetAssigned = sap.ui.xmlfragment(
					"com.twobm.mobileworkorder.components.workOrdersFromWorkCenter.fragments.FilterAssignedToActionSheet",
					this
				);
		...
		onFilterWorkCenter: function(oEvent) {
			...
			if (!this._actionSheetWorkCenter) {
				this._actionSheetWorkCenter = sap.ui.xmlfragment(
					"com.twobm.mobileworkorder.components.workOrdersFromWorkCenter.fragments.FilterWorkCenterActionSheet",
					this
				);
			...
			if (!this._workCenterPopover) {
				this._workCenterPopover = sap.ui.xmlfragment("WorkCenterPopover",
					"com.twobm.mobileworkorder.components.workOrdersFromWorkCenter.fragments.FilterWorkCenterPopover",
					this);
				...
				this._workCenterPopover.attachBeforeClose(function() {
